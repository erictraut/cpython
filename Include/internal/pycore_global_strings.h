...
struct _Py_global_strings {
    struct {
        ...
        STRUCT_FOR_STR(generic, "Generic")
    ...
    struct {
        STRUCT_FOR_ID(False)
        STRUCT_FOR_ID(ParamSpec)
        STRUCT_FOR_ID(Py_Repr)
        STRUCT_FOR_ID(TextIOWrapper)
        STRUCT_FOR_ID(True)
        STRUCT_FOR_ID(TypeAliasType)
        STRUCT_FOR_ID(TypeParameter)
        STRUCT_FOR_ID(TypeVar)
        STRUCT_FOR_ID(TypeVarTuple)
